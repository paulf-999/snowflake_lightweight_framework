...
GRANT CREATE TABLE, CREATE EXTERNAL TABLE, CREATE MATERIALIZED VIEW, CREATE PROCEDURE, CREATE TASK ON ALL SCHEMAS IN DATABASE &{PROGRAM}_&{ENV}_RAW_DB TO ROLE &{PROGRAM}_&{ENV}_DATA_LOADER;
GRANT CREATE TABLE, CREATE EXTERNAL TABLE, CREATE MATERIALIZED VIEW, CREATE PROCEDURE, CREATE TASK ON FUTURE SCHEMAS IN DATABASE &{PROGRAM}_&{ENV}_RAW_DB TO ROLE &{PROGRAM}_&{ENV}_DATA_LOADER;
